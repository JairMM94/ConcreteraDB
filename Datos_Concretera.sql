...
(1001, 'Juan Pérez', 'LIC12345', '555-123-4567', 'Activo'),
(1002, 'María López', 'LIC23456', '555-234-5678', 'Activo'),
(1003, 'Carlos Ramírez', 'LIC34567', '555-345-6789', 'Inactivo'),
(1004, 'Ana Torres', 'LIC45678', '555-456-7890', 'Activo'),
(1005, 'Luis Hernández', 'LIC56789', '555-567-8901', 'Activo'),
(1006, 'Sofía Gómez', 'LIC67890', '555-678-9012', 'Activo'),
(1007, 'Miguel Sánchez', 'LIC78901', '555-789-0123', 'Activo'),
(1008, 'Laura Díaz', 'LIC89012', '555-890-1234', 'Suspendido'),
...
(201, 'José', 'Martínez López', 5551112233, 'jose.martinez@concretera.com', 'Construcción', 18000, 'Operador de Planta', 1, '2021-03-15', NULL),
(202, 'María', 'González Pérez', 5552223344, 'maria.gonzalez@concretera.com', 'Residencial', 22000, 'Ingeniera de Calidad', 2, '2020-07-01', NULL),
(203, 'Carlos', 'Ramírez Torres', 5553334455, 'carlos.ramirez@concretera.com', 'Industrial', 25000, 'Supervisor de Producción', 1, '2019-05-20', NULL),
(204, 'Ana', 'Hernández Díaz', 5554445566, 'ana.hernandez@concretera.com', 'Infraestructura', 19500, 'Técnica de Laboratorio', 2, '2022-01-10', NULL),
(205, 'Luis', 'Sánchez Morales', 5555556677, 'luis.sanchez@concretera.com', 'Construcción', 17000, 'Auxiliar Administrativo', 3, '2023-06-05', NULL),
(206, 'Laura', 'Fernández Castro', 5556667788, 'laura.fernandez@concretera.com', 'Residencial', 21000, 'Ingeniera de Seguridad', 4, '2021-09-18', NULL),
(207, 'Miguel', 'Domínguez Ruiz', 5557778899, 'miguel.dominguez@concretera.com', 'Industrial', 28000, 'Gerente de Planta', 1, '2018-11-30', NULL),
(208, 'Sofía', 'Vargas Rojas', 5558889900, 'sofia.vargas@concretera.com', 'Construcción', 16000, 'Asistente de Ventas', 5, '2022-08-12', NULL),
(209, 'Pedro', 'Castillo Jiménez', 5559990011, 'pedro.castillo@concretera.com', 'Infraestructura', 18500, 'Operador de Camión', 6, '2020-04-03', NULL),
(210, 'Elena', 'Morales Flores', 5550001122, 'elena.morales@concretera.com', 'Residencial', 23000, 'Coordinadora de Logística', 3, '2019-02-21', NULL);

SELECT * FROM Empleados

INSERT INTO Roles VALUES
('Gerente de Planta', 'Encargado de supervisar toda la operación de la planta concretera.', 1, 'PLT', 'RW', 'A'),
('Supervisor de Producción', 'Supervisa la producción de concreto, asegurando cumplimiento de recetas y calidad.', 1, 'PLT', 'RW', 'A'),
('Ingeniero de Calidad', 'Realiza pruebas de laboratorio y controla calidad del producto.', 2, 'PLT', 'RW', 'A'),
('Operador de Planta', 'Maneja el sistema de mezclado y producción del concreto.', 1, 'PLT', 'RW', 'A'),
('Operador de Camión', 'Conduce y entrega el producto a obra.', 6, 'OBR', 'R', 'A'),
('Auxiliar Administrativo', 'Apoya en tareas de oficina y gestión documental.', 3, 'ADM', 'RW', 'A'),
('Coordinador de Logística', 'Organiza las rutas de entrega y disponibilidad de camiones.', 3, 'ADM', 'RW', 'A'),
('Técnico de Mantenimiento', 'Encargado de dar mantenimiento preventivo y correctivo a los equipos.', 4, 'PLT', 'RW', 'A'),
('Asistente de Ventas', 'Atiende clientes y genera cotizaciones.', 5, 'ADM', 'RW', 'A'),
('Gerente Comercial', 'Lidera las estrategias de ventas y relación con clientes clave.', 5, 'ADM', 'RW', 'A');

SELECT * FROM Roles

INSERT INTO Departamentos VALUES
('Producción', 'Operaciones', 'Planta', 1),
('Calidad', 'Laboratorio', 'Planta', 2),
('Administración', 'Gestión', 'Oficinas', 3),
('Mantenimiento', 'Servicios Técnicos', 'Planta', 4),
('Ventas', 'Comercial', 'Oficinas', 5),
('Logística y Transporte', 'Distribución', 'Campo', 6);
...
(7, 'Aditivo Retardante', 'Retrasa el tiempo de fraguado en climas cálidos', 1, 'RET'),
(8, 'Fibra de Polipropileno', 'Mejora el control de fisuras plásticas en el concreto', 1, 'OTR');
...
('Concreto Rápido (Acelerado)', 360.00, 690.00, 1120.00, 205.00, 3.00, 1.00);
...
(4, 'Particular Juan Hernández', 'juan.hernandez@gmail.com', 5554445566, 5, 'Particular', 0),
...
(8, 'Particular Ana López', 'ana.lopez@hotmail.com', 5558889900, 5, 'Particular', 0),
...
(4, 'Concreto F\c=300 kg/cm2', 'Concreto estructural de uso común en obra negra'),
(5, 'Concreto Bombeable', 'Diseñado para colocación con bomba en alturas y espacios reducidos'),
(6, 'Concreto Rápido', 'Con aditivos acelerantes, útil para reparaciones y obras urgentes'),
(7, 'Concreto Impermeable', 'Con aditivos que reducen filtración de agua, ideal para cisternas'),
(8, 'Concreto Alta Resistencia F\c=400', 'Concreto especial para grandes cargas y estructuras de puentes'),
(9, 'Mortero de Albañilería', 'Mezcla de cemento y arena para muros y acabados'),
...
(5, '2025-09-05', 4, 0, 'Boulevard López Mateos 56, León', 10.00, 2, 'Pendiente', 105),
(6, '2025-09-06', 5, 1, 'Parque Industrial Querétaro', 25.50, 1, 'En Proceso', 106),
(7, '2025-09-07', 3, 0, 'Zona Centro, Monterrey', 18.00, 5, 'Pendiente', 107),
(8, '2025-09-08', 2, 1, 'Carretera México-Toluca KM 45', 30.00, 3, 'Entregado', 108),
(9, '2025-09-09', 4, 1, 'Av. Universidad 654, Puebla', 9.75, 1, 'Pendiente', 109),
(10, '2025-09-10', 5, 0, 'Zona Industrial Norte, Mérida', 14.25, 4, 'En Proceso', 110);

SELECT * FROM Pedidos;

INSERT INTO Plantas VALUES
(1, 'Planta Norte CDMX', 'Centro', 'Construcción Urbana', 'MEX'),
(2, 'Planta Monterrey', 'Noreste', 'Industrial', 'MEX'),
(3, 'Planta Guadalajara', 'Occidente', 'Residencial', 'MEX'),
(4, 'Planta León', 'Bajío', 'Comercial', 'MEX'),
(5, 'Planta Mérida', 'Sureste', 'Infraestructura', 'MEX');
...
(102, 2, '2025-09-02', 'Crédito', 9500.000),
(103, 3, '2025-09-03', 'Contado', 18750.000),
(104, 4, '2025-09-04', 'Crédito', 22000.000),
(105, 5, '2025-09-05', 'Contado', 11000.000);

SELECT * FROM Ventas;

INSERT INTO Reconcilacion VALUES
(1, 1, 1, 12.50, 12.50, 12.00, GETDATE(), 'Diferencia menor por evaporación'),
(2, 2, 2, 8.00, 8.00, 7.80, GETDATE(), 'Entrega completa con ligera merma'),
(3, 3, 3, 15.75, 15.75, 0.00, GETDATE(), 'Camión aún en ruta'),
